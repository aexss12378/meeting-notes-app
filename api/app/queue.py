...
class JobQueue:
    ...
    def create_job(self, meeting_id: str, attempt: int = 0) -> dict[str, Any]:
        ...
        self.redis.lpush(self.queue_name, json.dumps({"job_id": job_id, "meeting_id": meeting_id, "attempt": attempt}))
        return payload

    def enqueue_existing(self, job_id: str, meeting_id: str, attempt: int) -> None:
        self.redis.lpush(self.queue_name, json.dumps({"job_id": job_id, "meeting_id": meeting_id, "attempt": attempt}))
