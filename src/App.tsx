  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {activeTab === "tags" && (
          <div className="p-8">
            <h1 className="text-2xl font-bold text-zinc-100">標籤</h1>
            <p className="mt-2 text-zinc-500">這個分頁先保留給之後整理會議用。</p>
          </div>
        )}

        {activeTab === "search" && (
          <div className="p-8">
            <h1 className="text-2xl font-bold text-zinc-100">搜尋</h1>
            <p className="mt-2 text-zinc-500">這個分頁先保留給之後搜尋會議與摘要用。</p>
          </div>
        )}
      </main>
    </div>
